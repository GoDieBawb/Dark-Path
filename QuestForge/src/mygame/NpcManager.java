...
import mygame.Quests.Mission1.BillyQuest;
  ...
  public void update(float tpf) {
    ...
    for (int i = 0; i < npcNode.getQuantity(); i++) {
      ...
      if (distance < 5) {
        ...
        //Checks for special npcs
        if (currentNpc.getName().equals("Little Billy")) {
          ((BillyQuest) currentNpc.quest).billyChecker(npcNode);
          }
